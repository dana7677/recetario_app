              ...
              child: Stack( 
                children: [ 
                  ...
                  Positioned(
                        ...
                        right: 10,
                        child:
                           IconButton( icon: const Icon(Icons.dehaze, color: Color.fromARGB(255, 255, 255, 255),size: 30,fontWeight: FontWeight.bold),
                        ...
                        child: Card(
                          ...
                          borderRadius: BorderRadius.circular(12)),
                            child: Padding(
                              ...
                              child: Text("⭐ ${receta.stars}",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold)),
                            )
                        ),
                      ),
                      SizedBox(
                        ...
                        child: Card(
                          ...
                          borderRadius: BorderRadius.circular(12)),
                            child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text("⏱ ${receta.tiempo} min",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold)),
                            )
                        ),
                      ),
                      SizedBox(
                        ...
                        child: Card(
                          ...
                          borderRadius: BorderRadius.circular(12)),
                            child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text("📊 ${getDificultad(receta.dificultad)}",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold)),
                            )
                        ),
                      ),
                      /*
...
List<RecetaModel> filtrarReceta(TipoReceta tipoFiltrar,List<RecetaModel> recetaOriginal)
{
  List<RecetaModel> recetaFiltrada=[];

  for(int i=0; i<recetaOriginal.length;i++)
  {
    if(recetaOriginal[i].tipoReceta==tipoFiltrar)
    {
      recetaFiltrada.add(recetaOriginal[i]);
    }
  }
...
final List<RecetaModel> listaRecetaOriginal = [
  ...
  void filterRecipesBy(TipoReceta tipoFiltrar) {
    setState(() {
      ...
      {
        listaRecetas=filtrarReceta(tipoFiltrar, listaRecetaOriginal);
      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          ...
          child: Row(
            ...
            children: [
              IconButton(onPressed: (){filterRecipesBy(TipoReceta.desayuno);}, icon: Icon(Icons.free_breakfast_outlined,color:isIconFilter(TipoReceta.desayuno) ?Colors.amber :Colors.grey)),
              IconButton(onPressed: (){filterRecipesBy(TipoReceta.almuerzo);}, icon: Icon(Icons.lunch_dining_outlined,color:isIconFilter(TipoReceta.almuerzo) ?Colors.amber :Colors.grey)),
              IconButton(onPressed: (){filterRecipesBy(TipoReceta.comida);}, icon: Icon(Icons.fastfood,color:isIconFilter(TipoReceta.comida) ?Colors.amber :Colors.grey)),
              IconButton(onPressed: (){filterRecipesBy(TipoReceta.postres);}, icon: Icon(Icons.icecream_outlined,color:isIconFilter(TipoReceta.postres) ?Colors.amber :Colors.grey)),
              IconButton(onPressed: () {filterRecipesBy(TipoReceta.bebida);}, icon: Icon(Icons.wine_bar,color:isIconFilter(TipoReceta.bebida) ?Colors.amber :Colors.grey)),
            ],
          )),
      ),
      backgroundColor: const Color.fromARGB(255, 255, 245, 220),
